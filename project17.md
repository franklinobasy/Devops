...
[Link to Terraform Implementation](https://github.com/franklinobasy/FO-Terraform)
...
Create an Internet Gateway in a separate Terraform file `internet_gateway.tf`. Enter the following codes into the file.
...
3. Attach the `Policy` to the `IAM Role`
   This is where, we will be attaching the policy which we created above, to the role we created.
