...
2. *Fixing multiple resource blocks:* This is where things become a little tricky. It’s not complex, we are just going to introduce some interesting concepts. Loops & Data sources
...
3. *The final problem to solve is removing hard coded count value.*
